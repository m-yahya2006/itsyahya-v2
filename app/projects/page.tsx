...
export default function ProjectsPage() {
  return (
    <main className="portfolio">
      <Navbar />
      <section className="page-hero"><div className="site-container page-hero-grid"><div><p className="eyebrow">Selected Work</p><h1 className="page-title">Current project.<br/><span>In development.</span></h1></div><div className="page-hero-aside"><p>My current flagship project connects Civil Engineering with embedded sensing, autonomous mobility, telemetry and data analysis.</p></div></div></section>
        ...
        {projects.map((project)=>(
          <Reveal key={project.index}>
            <Link href={project.href} className="project-index-row">
              <div className="project-index-visual project-aevns-visual"><span>{project.status}</span></div>
